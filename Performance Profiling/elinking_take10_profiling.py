...
def calc_function_time(function_starttime, function_name):

        end_time_function = datetime.now()

        delta_within_function = end_time_function - function_starttime
        delta_from_Start = end_time_function - overal_start_time

#        print("TIME INFO !!!!!!!!! Execution time for function: " + function_name  + " is:"  + str(delta_within_function.microseconds) + "." + "Percentage of total time: " + str(delta_within_function.microseconds / delta_from_Start.microseconds))
        print("TIME_INFO - Execution time for function:" + function_name  + ":is:"  + str(delta_within_function.microseconds))
	...
	try:
		...
		texts = soup.findAll(text=True)
        	visible_texts = filter(tag_visible, texts)
                ...
                calc_function_time(start_time_function, sys._getframe().f_code.co_name)
...
global overal_start_time
overal_start_time = datetime.now()

print("TIME_INFO - Starting to collect execution times.")
